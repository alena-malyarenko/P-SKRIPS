...
!
      ...
      character(ESMF_MAXSTR), dimension(1:34) :: nuopc_entryNameList=&
                   (/'LAND_MASK_VALUE','XLAT_VALUE','XLONG_VALUE',&
                     'LATENT_HEAT_SEAICE','SENSIBLE_HEAT_SEAICE',& 
                     'SHORT WAVE SEAICE',&
                     'LONG WAVE SEAICE',&
                     'LATENT_HEAT_OCEAN','SENSIBLE_HEAT_OCEAN',&
                     'SHORT WAVE OCEAN',&
                     'LONG WAVE OCEAN',&
                     'SURFACE RUNOFF',&
                     'SURFACE RUNOFF LAST',&
      ...
      character(ESMF_MAXSTR), dimension(1:34) :: wrf_nameList=&
                   (/'LANDMASK','XLAT','XLONG',&
                     ...
                     'LAND_RUNOFF',&
                     'U10','V10','T2','Q2',&                    
                     'SFCEVP','QFX','RAINBL','HAILNCV','GRAUPELNCV','SNOWNCV',&
                     'SNOWH_SI','DELTA_SNOW',&
