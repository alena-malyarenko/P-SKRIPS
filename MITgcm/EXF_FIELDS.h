...
#ifdef ALLOW_FLUXES_COUPLED     
     &                  , snowh,hs_ice,hl_ice,lwflux_ice,
     &                  swflux_ice          
      _RL snowh     (1-OLx:sNx+OLx,1-OLy:sNy+OLy,nSx,nSy)
      _RL hs_ice    (1-OLx:sNx+OLx,1-OLy:sNy+OLy,nSx,nSy)
      _RL hl_ice    (1-OLx:sNx+OLx,1-OLy:sNy+OLy,nSx,nSy)
      _RL lwflux_ice (1-OLx:sNx+OLx,1-OLy:sNy+OLy,nSx,nSy) 
      _RL swflux_ice (1-OLx:sNx+OLx,1-OLy:sNy+OLy,nSx,nSy)       	     	     	
#endif      		
...
#ifdef ALLOW_FLUXES_COUPLED
     &  , land_runoff, land_runoff0, land_runoff1
      _RL land_runoff     (1-OLx:sNx+OLx,1-OLy:sNy+OLy,nSx,nSy)
      _RL land_runoff0     (1-OLx:sNx+OLx,1-OLy:sNy+OLy,nSx,nSy)
      _RL land_runoff1     (1-OLx:sNx+OLx,1-OLy:sNy+OLy,nSx,nSy)
#endif	
